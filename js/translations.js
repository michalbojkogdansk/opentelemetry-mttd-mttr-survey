...
const translations = {
    ...
    "Jaka jest według Ciebie największa korzyść z wdrożenia OpenTelemetry?": {
        "pl": "Jaka jest według Ciebie największa korzyść z wdrożenia OpenTelemetry?",
        "en": "What do you think is the biggest benefit of implementing OpenTelemetry?"
    },
    "Jakie jest według Ciebie największe wyzwanie związane z OpenTelemetry?": {
        "pl": "Jakie jest według Ciebie największe wyzwanie związane z OpenTelemetry?",
        "en": "What do you think is the biggest challenge related to OpenTelemetry?"
    },
    "Adres e-mail do przesłania wyników badania": {
        "pl": "Adres e-mail do przesłania wyników badania",
        "en": "Email address to receive study results"
    },
    "Dziękuję za wypełnienie ankiety!": {
        "pl": "Dziękuję za wypełnienie ankiety!",
        "en": "Thank you for completing the survey!"
    },
    "Ze względu na krótkie doświadczenie możesz podać wartości orientacyjne lub pozostawić pola puste.": {
        "pl": "Ze względu na krótkie doświadczenie możesz podać wartości orientacyjne lub pozostawić pola puste.",
        "en": "Due to your short experience, you can provide approximate values or leave the fields blank."
    },
    "Wartość od 0 do 10080 (maksymalnie tydzień)": {
        "pl": "Wartość od 0 do 10080 (maksymalnie tydzień)",
        "en": "Value from 0 to 10080 (maximum one week)"
    },
    "Wartość od 0 do 43200 (maksymalnie miesiąc)": {
        "pl": "Wartość od 0 do 43200 (maksymalnie miesiąc)",
        "en": "Value from 0 to 43200 (maximum one month)"
    },
    "Twoje szczegółowe odpowiedzi są bardzo cenne dla badania. Opisz swoje doświadczenia własnymi słowami.": {
        "pl": "Twoje szczegółowe odpowiedzi są bardzo cenne dla badania. Opisz swoje doświadczenia własnymi słowami.",
        "en": "Your detailed answers are very valuable for the research. Describe your experience in your own words."
    },
    "(jeśli nie używasz OTel, opisz oczekiwaną korzyść)": {
        "pl": "(jeśli nie używasz OTel, opisz oczekiwaną korzyść)",
        "en": "(if you don't use OTel, describe the expected benefit)"
    },
    "(wdrożenie, użytkowanie, integracja itp.)": {
        "pl": "(wdrożenie, użytkowanie, integracja itp.)",
        "en": "(implementation, usage, integration, etc.)"
    },
    "(opcjonalnie)": {
        "pl": "(opcjonalnie)",
        "en": "(optional)"
